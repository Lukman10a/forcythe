  ...
  return (
    ...
    >
      ...
      {applyMask && (
        <div
          className={cn(
            "pointer-events-none absolute inset-0 z-10 h-full w-full via-transparent via-80% to-white/15 to-95% dark:from-gray-800/50 dark:via-transparent dark:to-gray-800/50",
            {
